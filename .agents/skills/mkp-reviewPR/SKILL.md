...
## Dependencies
- [mkp-review-code](../mkp-review-code/SKILL.md)
- [mkp-reviewSecurityPerformance](../mkp-reviewSecurityPerformance/SKILL.md)
...
### Step 3 — Thực hiện `mkp-review-code`
Đánh giá Functional, Architecture, Code Quality, Design.

### Step 4 — Thực hiện `mkp-reviewSecurityPerformance`
