...
- **Web Frontend**: Mọi code liên quan đến web phải tuân thủ tài liệu trong `web_architecture/`
- **Backend**: Mọi code liên quan đến backend phải tuân thủ tài liệu trong `backend_architecture/`
- **UI/UX & Localization**: Các task liên quan đến giao diện và L10n phải tuân thủ `web_architecture/design/design.md` và [Shared UI & Localization Rules](shared-ui-l10n-rules.md)
