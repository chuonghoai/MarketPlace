...
3. **Inspect Architecture (Kiểm tra kiến trúc)**
   - Đọc các tài liệu kiến trúc: `web_architecture/`, `backend_architecture/`.
   - Đọc tài liệu UI/UX & L10n: `web_architecture/design/design.md` và `shared-ui-l10n-rules.md` (nếu có thay đổi UI/text).
